...
export const KURARI_EX_ANALYSIS_INVENTORY = [
  ...
  item("race-type", "条件別", "レース種目別", "existing", "条件別データ / PLAYER CATEGORY ANALYSIS", ["byRaceStage", "byClass"], "condition-data", "既存条件別へ集約", "安全分類済みの種目だけ", "準決勝と決勝など曖昧分類を混ぜない。"),
  ...
  item("grade", "条件別", "グレード別", "future-accumulation", "未表示", [], null, "条件別データの将来拡張", "保存済みbyGradeまたは確定grade", "byClassをG3/F1/F2へ読み替えない。"),
